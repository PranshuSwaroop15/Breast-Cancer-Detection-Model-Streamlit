# Breast-Cancer-Detection-Model-Streamlit
Breast Cancer Detection Model using Logistic Regression [Dataset](https://www.kaggle.com/datasets/uciml/breast-cancer-wisconsin-data). 
